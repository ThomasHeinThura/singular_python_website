...
with st.container():
    ...
    with column_three:
        st.markdown(
            "[Changing career transition is challenging!!!](https://medium.com/@thomas.heinthura/changing-career-transition-is-challenging-93d35f6ac744)"
        )
        st.image(
